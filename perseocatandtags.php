...
// Save the image data when the term is saved
function perseo_save_taxonomy_image($term_id) {
...
add_action('created_category', 'perseo_save_taxonomy_image');
add_action('created_post_tag', 'perseo_save_taxonomy_image');
...
function perseo_enable_svg_upload($mimes) {
    $mimes['svg'] = 'image/svg+xml';
    return $mimes;
}
add_filter('upload_mimes', 'perseo_enable_svg_upload');
